...
int main()
{
    ...
    if (sol.validateBinaryTreeNodes(n, leftChild, rightChild))
        cout << "The given nodes form a valid binary tree." << endl;
    else
        cout << "The given nodes do not form a valid binary tree." << endl;
